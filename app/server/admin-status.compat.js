...
(function () {
  ...
  function _request() {
    _request = _asyncToGenerator(_regenerator().m(function _callee(url, options) {
  ...
  function _cancelAll() {
    _cancelAll = _asyncToGenerator(_regenerator().m(function _callee2() {
      var failures, sent, data, pending, _iterator3, _step3, job, message, _t, _t2, _t3;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 14:
            _context2.p = 14;
            _t3 = _context2.v;
            showNotice(_t3.message);
            syncToast(_t3.message, false);
          case 15:
            _context2.p = 15;
            stoppingAll = false;
            render(knownJobs);
      ...
      }, _callee2, null, [[6, 8], [4, 11, 12, 13], [2, 14, 15, 16]]);
    }));
    return _cancelAll.apply(this, arguments);
  }
  function cancel(_x3) {
  ...
  function _cancel() {
    _cancel = _asyncToGenerator(_regenerator().m(function _callee3(id) {
      var job, _t4;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 4:
            _context3.p = 4;
            _t4 = _context3.v;
            showNotice(_t4.name === 'AbortError' ? 'لم يصل تأكيد الإيقاف؛ تُحدّث الحالة تلقائياً.' : _t4.message);
          case 5:
            _context3.p = 5;
  ...
  function _poll() {
    _poll = _asyncToGenerator(_regenerator().m(function _callee4() {
      var authenticationRequired, data, _iterator4, _step4, job, id, previous, sections, _t5, _t6;
...
(function () {
  ...
  function _poll2() {
    _poll2 = _asyncToGenerator(_regenerator().m(function _callee6() {
      var eventsList, response, data, summary, _iterator5, _step5, _loop, _t7, _t8;
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.p = _context7.n) {
                ...
                while (1) switch (_context6.n) {
                  case 0:
                    ...
                    if (['queued', 'running'].includes(job.status)) {
                      ...
                      cancel.onclick = _asyncToGenerator(_regenerator().m(function _callee5() {
          ...
          case 8:
            ...
            return _context7.d(_regeneratorValues(_loop()), 9);
          case 9:
            _context7.n = 8;
            break;
          case 10:
      ...
      }, _callee6, null, [[7, 11, 12, 13], [0, 14, 15, 16]]);
    }));
    return _poll2.apply(this, arguments);
  }
  window.addEventListener('pagehide', () => {
